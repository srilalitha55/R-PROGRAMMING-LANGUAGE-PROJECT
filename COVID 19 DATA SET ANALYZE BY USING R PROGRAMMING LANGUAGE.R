...
data<- read.csv("D:/SRI LALITHA/BUSINESS ANALYST PROJECTS/DOWNLOADED PROJECTS FROM YOUTUBE/TECH TRIBE/R - PROGRAMMING LANGUAGE COVID 19 DATA PROJECT/archive/COVID19_line_list_data.csv")
